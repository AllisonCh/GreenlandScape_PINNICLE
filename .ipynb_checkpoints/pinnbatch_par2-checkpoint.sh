#!/bin/bash
#SBATCH --job-name=pinn2025-Feb_13_13G        # Job name (or -J my_job_name)
...
srun -G1 -n1 -N1 python Ryder_MOLHO_H_pde5.py & 
srun -G1 -n1 -N1 python Ryder_MOLHO_H_pde6.py &
srun -G1 -n1 -N1 python Ryder_MOLHO_H_pde7.py & 
srun -G1 -n1 -N1 python Ryder_MOLHO_H_pde8.py & wait
