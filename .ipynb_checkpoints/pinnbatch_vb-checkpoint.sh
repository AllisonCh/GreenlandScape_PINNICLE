#!/bin/bash
#SBATCH --job-name=pinn2025-Jan-31_G8        # Job name (or -J my_job_name)
...
srun -G1 -n1 -N1 python Ryder_MOLHO_vb1.py & 
srun -G1 -n1 -N1 python Ryder_MOLHO_vb2.py &
srun -G1 -n1 -N1 python Ryder_MOLHO_vb3.py & wait