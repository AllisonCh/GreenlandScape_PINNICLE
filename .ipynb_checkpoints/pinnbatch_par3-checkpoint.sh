#!/bin/bash
# -*- coding: utf-8 -*-
#SBATCH --job-name=pinn2025-Feb_13_17G        # Job name (or -J my_job_name)
...
srun -G1 -n1 -N1 python Ryder_MOLHO_H_pde9.py & 
srun -G1 -n1 -N1 python Ryder_MOLHO_H_pde10.py &
srun -G1 -n1 -N1 python UpJak_MOLHO_H.py & wait
