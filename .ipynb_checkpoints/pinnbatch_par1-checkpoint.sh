#!/bin/bash
#SBATCH --job-name=pinn2025-Feb_11_11G        # Job name (or -J my_job_name)
...
#SBATCH --time=25:00:00                # Maximum runtime (D-HH:MM:SS)
...
srun -G1 -n1 -N1 python Ryder_MOLHO_H_short1.py & 
srun -G1 -n1 -N1 python Ryder_MOLHO_H_short2.py &
srun -G1 -n1 -N1 python Ryder_MOLHO_H_short3.py & 
srun -G1 -n1 -N1 python Ryder_MOLHO_H_short4.py & wait
