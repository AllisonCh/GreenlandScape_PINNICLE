#!/bin/bash
#SBATCH --job-name=pinn2025-Feb_5_5G        # Job name (or -J my_job_name)
...
#SBATCH --nodes=3                    # Number of nodes (or -N1)
...
srun -G1 -n1 -N1 python Ryder_MOLHO_dual_vb1.py & 
srun -G1 -n1 -N1 python Ryder_MOLHO_dual_vb2.py &
srun -G1 -n1 -N1 python Ryder_MOLHO_dual_vb3.py & wait
