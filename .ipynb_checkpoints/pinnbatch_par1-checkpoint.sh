#!/bin/bash
#SBATCH --job-name=pinn2025-Feb_6_2G        # Job name (or -J my_job_name)
...
srun -G1 -n1 -N1 python Ryder_MOLHO_H_long1.py & 
srun -G1 -n1 -N1 python Ryder_MOLHO_H_long2.py &
srun -G1 -n1 -N1 python Ryder_MOLHO_H_long3.py & 
srun -G1 -n1 -N1 python Ryder_MOLHO_H_long4.py & wait
