#!/bin/bash
#SBATCH --job-name=pinn2025-Feb_13_9G        # Job name (or -J my_job_name)
...
srun -G1 -n1 -N1 python Ryder_MOLHO_H_pde1.py & 
srun -G1 -n1 -N1 python Ryder_MOLHO_H_pde2.py &
srun -G1 -n1 -N1 python Ryder_MOLHO_H_pde3.py & 
srun -G1 -n1 -N1 python Ryder_MOLHO_H_pde4.py & wait
