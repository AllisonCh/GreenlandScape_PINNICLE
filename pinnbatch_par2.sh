#!/bin/bash
#SBATCH --job-name=pinn2025-Feb_6_6G        # Job name (or -J my_job_name)
...
#SBATCH --time=30:00:00                # Maximum runtime (D-HH:MM:SS)
...
srun -G1 -n1 -N1 python Ryder_MOLHO_H_long5.py & 
srun -G1 -n1 -N1 python Ryder_MOLHO_H_long6.py & 
srun -G1 -n1 -N1 python Ryder_MOLHO_H_long7.py & 
srun -G1 -n1 -N1 python Ryder_MOLHO_H_long8.py & wait
