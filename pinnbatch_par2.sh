...
srun -G1 -n1 -N1 python Ryder_MOLHO_H6.py & 
srun -G1 -n1 -N1 python Ryder_MOLHO_H7.py &  
srun -G1 -n1 -N1 python Ryder_MOLHO_H8.py & 
srun -G1 -n1 -N1 python Ryder_MOLHO_H9.py & wait
