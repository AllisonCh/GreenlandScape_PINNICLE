#!/bin/bash
# -*- coding: utf-8 -*-
#SBATCH --job-name=pinn2025-Feb_11_4G        # Job name (or -J my_job_name)
...
srun -G1 -n1 -N1 python Ryder_MOLHO_H_short4.py & 
srun -G1 -n1 -N1 python Ryder_MOLHO_H_short5.py &
srun -G1 -n1 -N1 python Ryder_MOLHO_H_short6.py & 
srun -G1 -n1 -N1 python Ryder_MOLHO_H_short7.py & wait
