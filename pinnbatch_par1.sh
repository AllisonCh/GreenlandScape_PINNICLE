#!/bin/bash
#SBATCH --job-name=pinn2025-Feb_17_1G        # Job name (or -J my_job_name)
...
srun -G1 -n1 -N1 python Ryder_MOLHO_H1a.py & 
srun -G1 -n1 -N1 python Ryder_MOLHO_H1b.py &
srun -G1 -n1 -N1 python Ryder_MOLHO_H1c.py &
srun -G1 -n1 -N1 python Ryder_MOLHO_H1d.py & wait
