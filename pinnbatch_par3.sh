#!/bin/bash
#SBATCH --job-name=pinn2025-Feb_5_11G        # Job name (or -J my_job_name)
...
srun -G1 -n1 -N1 python Ryder_MOLHO_H_dw1.py & 
srun -G1 -n1 -N1 python Ryder_MOLHO_H_dw2.py & 
srun -G1 -n1 -N1 python Ryder_MOLHO_H_dw2.py &  wait
