#!/bin/bash
#SBATCH --job-name=pinn2025-Feb_4_5G        # Job name (or -J my_job_name)
...
#SBATCH --time=20:00:00                # Maximum runtime (D-HH:MM:SS)
...
srun -G1 -n1 -N1 python Ryder_MOLHO_p1a.py & 
srun -G1 -n1 -N1 python Ryder_MOLHO_p2.py &
srun -G1 -n1 -N1 python Ryder_MOLHO_p3.py & wait
